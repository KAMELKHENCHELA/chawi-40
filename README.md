...
<table width="100%">
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>👤 About Me</h3>
      <ul>
        <li><strong>Name:</strong> Kamel Zerdoum</li>
      ...
      <ul>
        <li>🔭 Developing modern institutional systems and customized applications.</li>
        <li>🌱 Exploring advanced AI integrations for web ecosystems.</li>
      </ul>
    ...
    <td width="50%" valign="top" dir="rtl">
      ...
      <ul>
        <li>🔭 أعمل على بناء أنظمة مؤسسية متكاملة وتطبيقات مخصصة.</li>
        <li>🌱 أتعلم دمج تقنيات الذكاء الاصطناعي المتقدمة في الأنظمة البرمجية.</li>
      </ul>
